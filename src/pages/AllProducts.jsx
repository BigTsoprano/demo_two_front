          ...
          <div>
            {weights.length > 0 && (
              <div className="border-t">
                ...
                >
                  <div className="flex items-center text-slate-900 gap-x-2">Weight:</div>
                  <svg
            ...
            {types.length > 0 && (
              <div  className="border-t">
                ...
                >
                  <div  className="flex text-slate-900 items-center gap-x-2">Type:</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
            ...
            {effects.length > 0 && (
              <div  className="border-t">
                ...
                >
                  <div className="flex items-center text-slate-900 gap-x-2">Effect:</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
...
<div className="left2 border-r bg-white  rounded ">
      ...
      {modalOpen && <Modal closeModal={() => setModalOpen(false)} />}
        ...
        >
          ...
          <button onClick={() => setIsVisible(!isVisible)} className="filter-button">Close</button>
        </div>
        </motion.div>
)}
</AnimatePresence>
        ...
        <div className="right m-5 " >
          <div style={{alignItems:'flex-end'}} className="search-sort flex w-full justify-between border-b">
            ...
            <div className="sort absolute right-28">
              ...
              >
                <div className="flex items-center text-sm gap-x-2">Sort price</div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
